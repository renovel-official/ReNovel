...
export default function Policy(): ReactElement {
    return (
        <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10">
            ...
            <h2 className="text-xl font-semibold mt-6">第2条（アカウントについて）</h2>
            <p>本サイトに登録したメールアドレスは、APIなどの機能で使用されるため公開されます。</p>
            <p>ばれても問題ないメールアドレスを使用してください</p>
            ...
            <ul className="list-disc pl-6">
                ...
                <li>他者への誹謗中傷や嫌がらせ</li>
                <li>法律に違反する行為</li>
                <li>作者の許可を得ず他サイトに転載、また、自分以外の作品をReNovelに投稿すること</li>
            ...
            <p>2. 登録したメールアドレスの漏洩による損害についても、運営は責任を負いません。</p>
            <p>3. 運営は、予告なくサービスの内容を変更、停止することができます。</p>
            <p>4. 運営は、システムの不具合や障害によるデータ消失について責任を負いません。</p>
